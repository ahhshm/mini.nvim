...
---     - Vertical linewise movement gets reindented with |v_=|.
...
---       While 'mini.move' doesn't by design.
...
---
--- Notes:
--- - Vertical movement mode is followed up by reindent with |v_=|.
--- - Horizontal movement in linewise mode is almost the same as |<<| and |>>|
---   with a different handling of |v:count| (multiplies shift effect instead
---   of modifying this number of lines).
---
---@param direction string One of "left", "down", "up", "right".
...
H.default_config = MiniMove.config
